...
gameMatrix = arrayfun(@(x) rem(find(markerThrow'==x),2),1:widhtSize,'UniformOutput',0); % 10 = red 20 = Blue
...
%Vertical check
verticalCheck = arrayfun(@(x) checkFormation(gameMatrix(:,x)'),1:widhtSize,'UniformOutput',0);
